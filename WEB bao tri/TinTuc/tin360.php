   ...
   <?php include('includes/header.php');?>
    ...
    <div class="main">
        <div class="left">
            <div class="left_1">
                <a href="#">
                    <h3 style="font-family: 'Times New Roman', Times, serif; color:red">Tin nhanh 360</h3>
                </a>
                <ul>
                    <?php
                    $query = mysqli_query($con, "select MaTinTuc, TieuDe, tintuc.MoTa, Anh, NgayDang, url from tintuc, theloai where theloai.MaTL = tintuc.MaTL and theloai.TenTL = 'Tin nhanh 360'");
